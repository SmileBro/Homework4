...
import (
	infra "Homework4/distance/navigator/infra"
...
func (m *MockGeocoding) Geocode(address string) (point.Point, error) {
	m.ctrl.T.Helper()
...
func (m *MockGeocoding) ReverseGeocode(point point.Point) (infra.GeocodeData, error) {
	m.ctrl.T.Helper()
